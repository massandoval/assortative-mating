...
TOTALPOP<-1000
LAstep <- 100
system(paste("rm ",path,"runrunfile_slimAutX_pulses_true_predicted_scale_10E3.sh",sep=""))
for (pop in 1:length(colnames(pops))){
  ...
  param_predicted<-read.table("./mean_parameter_allpop_ftrue.txt",header=TRUE)
	...
	prop_pop1_t1=as.character(round(param_predicted[,"value"][(param_predicted[,"parameter"]=="GFR1")&(param_predicted[,"pop"]==POPname)],digits=5))
	prop_pop2_t1=as.character(round(param_predicted[,"value"][(param_predicted[,"parameter"]=="GFR2")&(param_predicted[,"pop"]==POPname)],digits=5))
	prop_pop3_t1=as.character(round(param_predicted[,"value"][(param_predicted[,"parameter"]=="GFR3")&(param_predicted[,"pop"]==POPname)],digits=5))
	print("NEW_MODEL")
	...
	output_jobfile <- paste(pathEph,colnames(pops)[pop],"/Slim_output_AutX_pulses_true_predicted_",colnames(pops)[pop],"_AM1_",as.character(AM1),"_AM2_",as.character(AM2),"_AM3_",as.character(AM3),"_SB1_",as.character(SB1),"_SB2_",as.character(SB2),"_GEN_",as.character(GEN),"_POP1_",as.character(POP1),"_POP2_",as.character(POP2),"_POP3_",as.character(POP3),"_scale_",SCALE,"_run_${PBS_ARRAY_INDEX}.txt",sep="")
	fragsfile <- paste(pathHumanPop,colnames(pops)[pop],"/fragments/Frags_AutX_pulses_true_predicted_",colnames(pops)[pop],"_AM1_",as.character(AM1),"_AM2_",as.character(AM2),"_AM3_",as.character(AM3),"_SB1_",as.character(SB1),"_SB2_",as.character(SB2),"_GEN_",as.character(GEN),"_POP1_",as.character(POP1),"_POP2_",as.character(POP2),"_POP3_",as.character(POP3),"_scale_",SCALE,"_run_${PBS_ARRAY_INDEX}.txt",sep="")
	ancfile <- paste(pathHumanPop,colnames(pops)[pop],"/ancestries/Ancestries_AutX_pulses_true_predicted_",colnames(pops)[pop],"_AM1_",as.character(AM1),"_AM2_",as.character(AM2),"_AM3_",as.character(AM3),"_SB1_",as.character(SB1),"_SB2_",as.character(SB2),"_GEN_",as.character(GEN),"_POP1_",as.character(POP1),"_POP2_",as.character(POP2),"_POP3_",as.character(POP3),"_scale_",SCALE,"_run_${PBS_ARRAY_INDEX}.txt",sep="")
    ...
    " -d prop_pop1_t1=",prop_pop1_t1,
    " -d prop_pop2_t1=",prop_pop2_t1,
    " -d prop_pop3_t1=",prop_pop3_t1,
    " -d prop_pop1_t3=0",
    " -d prop_pop2_t3=0",
    " -d prop_pop3_t3=0",		                          
    " ",
	...
	runjobfile <-paste(path,colnames(pops)[pop],"/run_job_pulses_true_AM1_",as.character(AM1),"_AM2_",as.character(AM2),"_AM3_",as.character(AM3),"_SB1_",as.character(SB1),"_SB2_",as.character(SB2),"_GEN_",as.character(GEN),"_POP1_",as.character(POP1),"_POP2_",as.character(POP2),"_POP3_",as.character(POP3),"_scale_",SCALE,".sh",sep="")
	jobname <- paste("job_pulses_true_predicted_",colnames(pops)[pop],"_AM1_",as.character(AM1),"_AM2_",as.character(AM2),"_AM3_",as.character(AM3),"_SB1_",as.character(SB1),"_SB2_",as.character(SB2),"_GEN_",as.character(GEN),"_POP1_",as.character(POP1),"_POP2_",as.character(POP2),"_POP3_",as.character(POP3),sep="")
	...
	write(systemcommandNJOBS,paste(path,"runrunfile_slimAutX_pulses_true_predicted_scale_10E3.sh",sep=""),append=TRUE)
	write(qsubcommand,paste(path,"runrunfile_slimAutX_pulses_true_predicted_scale_10E3.sh",sep=""),append=TRUE)
	system(paste("chmod 770 ",path,"runrunfile_slimAutX_pulses_true_predicted_scale_10E3.sh",sep=""))
}
