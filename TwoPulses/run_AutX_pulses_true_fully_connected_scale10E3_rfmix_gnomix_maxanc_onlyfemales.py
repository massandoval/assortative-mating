...
AMcomb_file='./AM_combinations_pulses_true_scale_'+str(POPnum)+'_pop_'+str(POPnum)+'.txt'
...
#    prop_pop3_t2 = AMFMSB[11]
    #print(run)
    input_frag ='./'+str(POPname)+'/fragments/Frags_AutX_pulses_true_GEN_19_POP1_'+str(POP1)+'_POP2_'+str(POP2)+'_totalpop_1000_pop_'+str(POPnum)+'_'+str(POPname)+'_scale_1000_run_'+str(run)+'.txt'
...
prop_pop1_t1_trainval, prop_pop1_t1_test = train_test_split(prop_pop1_t1_vec, test_size=0.2, shuffle= False)
prop_pop2_t1_trainval, prop_pop2_t1_test = train_test_split(prop_pop2_t1_vec, test_size=0.2, shuffle= False)
prop_pop3_t1_trainval, prop_pop3_t1_test = train_test_split(prop_pop3_t1_vec, test_size=0.2, shuffle= False)
y_trainval=[AM1vec_t1_trainval,
            AM2vec_t1_trainval,
            AM3vec_t1_trainval,
            SB1vec_t1_trainval,
            SB2vec_t1_trainval,
            prop_pop1_t1_trainval,
            prop_pop2_t1_trainval,
            prop_pop3_t1_trainval]
...
input_layer= Input(shape=(int(bins),ancestries,2))
#Flatten input
...
#Final prop1_t1 hidden layer, dropout and output layer
prop_pop1_t1_dense_layer = Dense(units=32, activation='relu')(common_dropout)
prop_pop1_t1_dropout1 = Dropout(0.2)(prop_pop1_t1_dense_layer)
prop_pop1_t1_output = Dense(units=1, name='prop_pop1_t1_output', activation='sigmoid')(prop_pop1_t1_dropout1)

#Final prop1_t1 hidden layer, dropout and output layer
prop_pop2_t1_dense_layer = Dense(units=32, activation='relu')(common_dropout)
prop_pop2_t1_dropout1 = Dropout(0.2)(prop_pop2_t1_dense_layer)
prop_pop2_t1_output = Dense(units=1, name='prop_pop2_t1_output', activation='sigmoid')(prop_pop2_t1_dropout1)

#Final prop1_t1 hidden layer, dropout and output layer
prop_pop3_t1_dense_layer = Dense(units=32, activation='relu')(common_dropout)
prop_pop3_t1_dropout1 = Dropout(0.2)(prop_pop3_t1_dense_layer)
prop_pop3_t1_output = Dense(units=1, name='prop_pop3_t1_output', activation='sigmoid')(prop_pop3_t1_dropout1)

model = Model(inputs=input_layer, outputs=[am1_output, am2_output, am3_output, sb1_output, sb2_output, prop_pop1_t1_output, prop_pop2_t1_output, prop_pop3_t1_output])
...
history_df['NN']=NNrun
with open("/rds/general/project/human-popgen-datasets/live/CNN_AM/log_pulses_true_newgenmap/loss_epochs_pulses_TRUE_"+str(POPname)+"_gnomix_maxanc_bins_"+str(bins)+"_normoption_"+str(option)+"_onlyfemales.txt", 'a') as f:
...
y_test_df.columns = ['AM1_true', 'AM2_true', 'AM3_true', 'SB1_true', 'SB2_true','prop_pop1_t1_true','prop_pop2_t1_true','prop_pop3_t1_true']
y_pred_df=pd.DataFrame(y_pred).T
y_pred_df.columns = ['AM1_pred', 'AM2_pred', 'AM3_pred','SB1_pred', 'SB2_pred','prop_pop1_t1_pred','prop_pop2_t1_pred','prop_pop3_t1_pred']
...
y_real_pred_rfmix_df.columns = ['AM1', 'AM2', 'AM3', 'SB1', 'SB2','prop_pop1_t1','prop_pop2_t1','prop_pop3_t1']
####
...
y_real_pred_gnomix_df.columns = ['AM1', 'AM2', 'AM3', 'SB1', 'SB2','prop_pop1_t1','prop_pop2_t1','prop_pop3_t1']
####

y_true_pred[['NN']]=NNrun
y_true_pred.to_csv("/rds/general/project/human-popgen-datasets/live/CNN_AM/log_pulses_true_newgenmap/truepred_pulses_TRUE_"+str(POPname)+"_gnomix_maxanc_bins_"+str(bins)+"_normoption_"+str(option)+"_onlyfemales.txt", index=None, sep=' ', mode='a')

file_mse_object = open("/rds/general/project/human-popgen-datasets/live/CNN_AM/log_pulses_true_newgenmap/MSE_R2_test_pulses_TRUE_"+str(POPname)+"_gnomix_maxanc_bins_"+str(bins)+"_normoption_"+str(option)+"_onlyfemales.txt", 'a')
...
file_mse_object.write("prop_pop1_t1 MSE "+str(mean_squared_error(y_true_pred['prop_pop1_t1_true'],y_true_pred['prop_pop1_t1_pred']))+" "+str(NNrun)+"\n")
file_mse_object.write("prop_pop2_t1 MSE "+str(mean_squared_error(y_true_pred['prop_pop2_t1_true'],y_true_pred['prop_pop2_t1_pred']))+" "+str(NNrun)+"\n")
file_mse_object.write("prop_pop3_t1 MSE "+str(mean_squared_error(y_true_pred['prop_pop3_t1_true'],y_true_pred['prop_pop3_t1_pred']))+" "+str(NNrun)+"\n")
...
file_mse_object.write("prop_pop1_t1 R2 "+str(r2_score(y_true_pred['prop_pop1_t1_true'],y_true_pred['prop_pop1_t1_pred']))+" "+str(NNrun)+"\n")
file_mse_object.write("prop_pop2_t1 R2 "+str(r2_score(y_true_pred['prop_pop2_t1_true'],y_true_pred['prop_pop2_t1_pred']))+" "+str(NNrun)+"\n")
file_mse_object.write("prop_pop3_t1 R2 "+str(r2_score(y_true_pred['prop_pop3_t1_true'],y_true_pred['prop_pop3_t1_pred']))+" "+str(NNrun)+"\n")
file_mse_object.close()

file_pred_gnomix_object = open("/rds/general/project/human-popgen-datasets/live/CNN_AM/log_pulses_true_newgenmap/predicted_pulses_TRUE_"+str(POPname)+"_gnomix_maxanc_bins_"+str(bins)+"_normoption_"+str(option)+"_onlyfemales.txt", 'a')
...
file_pred_gnomix_object.write("prop_pop1_t1 pred "+str(np.mean(y_real_pred_gnomix_df,axis=0)['prop_pop1_t1'])+" "+str(NNrun)+"\n")
file_pred_gnomix_object.write("prop_pop2_t1 pred "+str(np.mean(y_real_pred_gnomix_df,axis=0)['prop_pop2_t1'])+" "+str(NNrun)+"\n")
file_pred_gnomix_object.write("prop_pop3_t1 pred "+str(np.mean(y_real_pred_gnomix_df,axis=0)['prop_pop3_t1'])+" "+str(NNrun)+"\n")
file_pred_gnomix_object.close()

file_pred_rfmix_object = open("/rds/general/project/human-popgen-datasets/live/CNN_AM/log_pulses_true_newgenmap/predicted_pulses_TRUE_"+str(POPname)+"_rfmix_maxanc_bins_"+str(bins)+"_normoption_"+str(option)+"_onlyfemales.txt", 'a')
...
file_pred_rfmix_object.write("prop_pop1_t1 pred "+str(np.mean(y_real_pred_rfmix_df,axis=0)['prop_pop1_t1'])+" "+str(NNrun)+"\n")
file_pred_rfmix_object.write("prop_pop2_t1 pred "+str(np.mean(y_real_pred_rfmix_df,axis=0)['prop_pop2_t1'])+" "+str(NNrun)+"\n")
file_pred_rfmix_object.write("prop_pop3_t1 pred "+str(np.mean(y_real_pred_rfmix_df,axis=0)['prop_pop3_t1'])+" "+str(NNrun)+"\n")
