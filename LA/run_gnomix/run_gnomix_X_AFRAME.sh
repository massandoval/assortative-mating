...
path_output="/rds/general/project/human-popgen-datasets/ephemeral/output_0.1_AFRAME/X"
python3	$path_gnomix/gnomix.py $path_input/HGDP_1000gNYC_3pop_target_rename_rfmix154_X_AFRAME.phased.vcf.gz $path_output X True $path_genetic_map/chrX_gnomix.b38.gmap $path_input/HGDP_1000gNYC_3pop_ref_rename_rfmix154_X.phased.vcf.gz $path_genetic_map/HGDP_1000g_X.samples
