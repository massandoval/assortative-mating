...
filename="/rds/general/project/human-popgen-datasets/live/HGDP_1000g/gnomix/query_results_0.1cM_"+str(chr)+".fb"
...
with open("/rds/general/user/amassand/home/SLIM_models/MODELS/pops/lengths_counts_gnomix_maxanc_CLM_chr_"+str(chr), 'wb') as f: 
    pickle.dump(lengths_counts,f)

with open("/rds/general/user/amassand/home/SLIM_models/MODELS/pops/length_anc_gnomix_CLM_maxanc_chr_"+str(chr), 'wb') as f:
