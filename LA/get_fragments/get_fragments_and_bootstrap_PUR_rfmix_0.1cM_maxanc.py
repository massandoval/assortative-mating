...
inds_1=np.where(all_inds[:,1]=="PUR")[0]*6
inds_2=np.where(all_inds[:,1]=="PUR")[0]*6+1
inds_3=np.where(all_inds[:,1]=="PUR")[0]*6+2
inds_4=np.where(all_inds[:,1]=="PUR")[0]*6+3
inds_5=np.where(all_inds[:,1]=="PUR")[0]*6+4
inds_6=np.where(all_inds[:,1]=="PUR")[0]*6+5
...
with open("/rds/general/user/amassand/home/SLIM_models/MODELS/pops/lengths_counts_rfmix_maxanc_PUR_chr_"+str(chr), 'wb') as f: 
    pickle.dump(lengths_counts,f)


with open("/rds/general/user/amassand/home/SLIM_models/MODELS/pops/length_anc_rfmix_PUR_maxanc_chr_"+str(chr), 'wb') as f:
